...
@section('content')
    ...
    <section class="mt-4 bg-stone-100  rounded-lg shadow-2xl p-8 w-2/6">
        ...
        <!--- cart body -->
        <div class="mt-4">
            <form action="{{route('laravelMobileAuthCheckOtpLogin')}}" class="flex flex-col " method="post">
                @csrf
                ...
                <label for="password" >
                    <span class="text-sm text-gray-700 ">رمز یکبا مصرف </span>
                    <span class="text-rose-500">*</span>
                </label>
                <input
                    type="tel"
                ...
                <div class="flex items-end justify-between mt-4" >
                    <a href="{{route('laravelMobileAuthLogin')}}" class="text-blue-500 text-sm hover:text-blue-600">
                     ورود با گذار واژه
                    </a>
